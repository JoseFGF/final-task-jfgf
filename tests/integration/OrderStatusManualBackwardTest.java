...
/**
 * T016 (US2): dispatcher/supervisor cambian manualmente {@code pending_review
 * -> in_progress} (retroceso sin el flujo de rechazo con comentario
 * obligatorio) -> 200. Usa la orden seed {@code a4444444}
 * ({@code pending_review}, con evidencia ya registrada).
 */
class OrderStatusManualBackwardTest extends BaseIntegrationTest {
  ...
  void movingBackFromPendingReviewToInProgressReturnsOk(Role role) throws Exception {
