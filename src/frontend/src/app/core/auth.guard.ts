 ...
 * sesión. Esto es únicamente una comprobación de UX (Principio II de la
 * constitution): la autorización real de cada petición la valida el
 * backend, incluso si esta guard se saltara o se manipulara desde el
 * cliente.
 */
...
/**
 * Fábrica de guard por rol, para uso futuro en rutas específicas de
