...
/**
 * US3, escenario 1 (FR-009, FR-011): un supervisor aprueba una orden en
 * {@code pending_review} y esta pasa a {@code closed}.
 *
...
class ReviewApproveTest extends BaseIntegrationTest {
  ...
  @Test
  void supervisorApprovesOrderAndItMovesToClosed() throws Exception {
