...
/**
 * Pantalla de login. Envía email/password a `POST /api/v1/auth/login` vía
 * `AuthService.login`, guarda el token recibido y navega a `/orders`. El
 * backend es la autoridad final sobre la validez de las credenciales (401
 * en caso contrario); este formulario solo valida presencia/formato de
 * campos por UX.
 */
@Component({
  selector: 'app-login',
