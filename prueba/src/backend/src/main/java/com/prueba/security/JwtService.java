 ...
 * {@link #generateToken(UUID, Role)} y {@link #parse(String)} son la misma
 * lógica de firma que usan {@code AuthService} (login real) y los tests
 * (generación directa de tokens para escenarios de autorización).
 */
@Component
